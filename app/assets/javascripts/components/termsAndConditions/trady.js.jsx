    ...
    return (
      <div className="how-it-works">
        ...
        <div className="how-it-works-item">
          ...
          <label className="text">When you have received payment MaintenanceApp will process a service fee of 10% if the invoice total is more than $500.00 or 15% if the invoice total is less than $500.00. Please note MaintenanceApp shares this service fee with the property management agency. So everybody wins :)</label>
        </div>
      </div>
    )
  },
