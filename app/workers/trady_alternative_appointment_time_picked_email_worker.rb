class TradyAlternativeAppointmentTimePickedEmailWorker 
  ...
  def perform(maintenance_request_id, appointment_id, trady_id, tenant_id)
    ...
    TradyMailer.alternative_appointment_picked_email(maintenance_request,appointment, trady, tenant).deliver
