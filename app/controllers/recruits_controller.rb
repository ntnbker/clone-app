class RecruitsController < ApplicationController
  ...
  def show
    ...
    @jfmo_request = JfmoRequest.includes(maintenance_request:[:action_status, :property,quote_requests:[:quotes, :trady]]).find_by(params[:id]).as_json(:include=>{:maintenance_request=>{:include=>{:action_status=>{},:property=>{}}}})
