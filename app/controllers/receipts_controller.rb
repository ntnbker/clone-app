class ReceiptsController < ApplicationController
  ...
  def show
    @receipt = Receipt.find_by(id:params[:id]).as_json(:include => {:invoices => {:include=>{:maintenance_request=>{:include=>{:property=>{}}}}}}, :uploaded_invoices=>{:include=>{:maintenance_request=>{:include=>{:property=>{}}}} })
    respond_to do |format|
