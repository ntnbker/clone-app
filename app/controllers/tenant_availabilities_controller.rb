class TenantAvailabilitiesController < ApplicationController
  ...
  def update
    availability_access = AvailabilityAccess.new(availability_access_params)
  ...
  def availability_access_params
    params.fetch(:availability_access, {}).permit(:availability_access, :maintenance_request_id)
  end
