var PrivacyPolicy = React.createClass({
  render() {
    return (
      <div id="static-pages" className="privacy-policy">
        <div className="scroll-bar">
          <h4 className="text-center title">Privacy Policy</h4>
          <p className="content level-1">
            In this Privacy Policy, '<b>us</b>' '<b>we</b>' or '<b>our</b>' means Lab Developed Pty Ltd (ACN 608 599 293). We are committed to respecting your privacy. Our Privacy Policy sets out how we collect, use, store and disclose your personal information.
          </p>
          <p className="content level-1">
          ...
          <ul className="content level-1">
            We may collect the following types of personal information:
          </ul>
          <li className="content level-2">
            name;
          </li>
          <li className="content level-2">
