class ServicesController < ApplicationController 
  ...
  def add_services
    ...
    if service_array[0] == '' && service_array.count == 1 
      ...
      redirect_to new_trady_payment_registration_path(maintenance_request_id:params[:skill][:maintenance_request_id], trady_company_id:params[:skill][:trady_company_id], trady_id:params[:skill][:trady_id])
    end  
  end
