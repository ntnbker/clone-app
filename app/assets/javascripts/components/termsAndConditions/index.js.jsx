    ...
    return (
      <div className="terms-and-conditions">
        <div className="scroll-bar">
          ...
          <p className="level-2">
            (b)any subsequent agreement for services you enter into with any Agent or Owner who was originally introduced to you through the JFMO Function – irrespective of whether this subsequent agreement for services is made on the platform or not,
            (“Referral Fee”).
